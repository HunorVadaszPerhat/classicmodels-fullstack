...
import { BulkOperationResult } from './employee.service';

/**
 * Displays the per-item outcome of a bulk operation.
 *
...
@Component({
  standalone: true,
  selector: 'app-employee-bulk-result-dialog',
...
export class EmployeeBulkResultDialogComponent {
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: BulkOperationResult,
    private ref: MatDialogRef<EmployeeBulkResultDialogComponent>,
  ) {}
